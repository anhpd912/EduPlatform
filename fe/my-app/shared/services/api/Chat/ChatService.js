...
export const ChatService = {
  ...
  // Get user's classes with members (students and teachers)
  getMyClasses: async () => {
    return privateApi.get("/api/classes/my-classes-with-members");
  },

  // Get class members (students and teacher)
  getClassMembers: async (classId) => {
    return privateApi.get(`/api/classes/${classId}/members`);
  },
};
