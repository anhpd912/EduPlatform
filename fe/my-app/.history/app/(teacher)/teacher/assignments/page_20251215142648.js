            ...
            <div className={styles.PreviewSection}>
              ...
              <div className={styles.PreviewGrid}>
                <div className={styles.PreviewItem}>
                  ...
                  <span className={styles.PreviewValue}>{formData.title || "N/A"}</span>
                </div>
                <div className={styles.PreviewItem}>
                  <span className={styles.PreviewLabel}>Course:</span>
                  <span className={styles.PreviewValue}>{formData.course || "N/A"}</span>
                </div>
                <div className={styles.PreviewItem}>
                  <span className={styles.PreviewLabel}>Subject:</span>
                  <span className={styles.PreviewValue}>{formData.subject || "N/A"}</span>
                </div>
                <div className={styles.PreviewItem}>
                  <span className={styles.PreviewLabel}>Duration:</span>
                  <span className={styles.PreviewValue}>{formData.duration ? `${formData.duration} Min` : "N/A"}</span>
                </div>
                <div className={styles.PreviewItem}>
