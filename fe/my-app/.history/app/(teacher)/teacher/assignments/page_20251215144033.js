        ...
        return (
          <div className={styles.StepContent}>
            <div className={styles.PreviewSection}>
              <h3>{t.previewAssignment}</h3>
              <div className={styles.PreviewGrid}>
                <div className={styles.PreviewItem}>
                  <span className={styles.PreviewLabel}>{t.class}:</span>
                  <span className={styles.PreviewValue}>
                    {formData.title || t.na}
                  </span>
                </div>
                <div className={styles.PreviewItem}>
                  <span className={styles.PreviewLabel}>{t.course}:</span>
                  <span className={styles.PreviewValue}>
                    {formData.course || t.na}
                  </span>
                </div>
                <div className={styles.PreviewItem}>
                  <span className={styles.PreviewLabel}>{t.subject}:</span>
                  <span className={styles.PreviewValue}>
                    {formData.subject || t.na}
                  </span>
                </div>
                <div className={styles.PreviewItem}>
                  <span className={styles.PreviewLabel}>{t.duration}:</span>
                  <span className={styles.PreviewValue}>
                    {formData.duration ? `${formData.duration} ${t.min}` : t.na}
                  </span>
                </div>
                <div className={styles.PreviewItem}>
