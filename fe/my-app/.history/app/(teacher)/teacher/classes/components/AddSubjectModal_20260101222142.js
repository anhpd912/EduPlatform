...
export default function AddSubjectModal({ classData, onClose, onSave }) {
  ...
  // Get teachers already in the class from classData.classTeachers
  const classTeachers = classData.classTeachers || [];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || t.errorSavingSubject || "Error saving subject");
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className={styles.Form}>
          ...
          <div className={styles.FormGroup}>
            ...
            {classTeachers.length === 0 ? (
              <div className={styles.NoTeachers}>
                {t.noTeachersInClass || "No teachers in this class. Please add a teacher first."}
              </div>
            ) : (
              <select
                name="teacherId"
          ...
          <div className={styles.FormActions}>
            ...
            <button
              ...
              disabled={loading || loadingSubjects || classTeachers.length === 0}
            >
