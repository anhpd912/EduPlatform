        ...
        <div className={styles.StatsGrid}>
          ...
          <div className={styles.StatCard}>
            ...
            <div className={styles.StatInfo}>
              ...
              <span className={styles.StatLabel}>{t.subjects || "Subjects"}</span>
            </div>
          </div>
          <div className={styles.StatCard}>
            <AssignmentIcon />
            ...
            <tbody>
              {classData.classEnrollments.map((enrollment, index) => (
                <tr key={enrollment.id || index}>
                  <td>{index + 1}</td>
                  <td>{enrollment.studentName || enrollment.student?.fullName || "-"}</td>
                  <td>
            ...
            <tbody>
              {classData.assignments.map((assignment, index) => (
                <tr key={assignment.id || index}>
                  ...
                  <td>{assignment.subjectName || assignment.subject?.name || "-"}</td>
                  <td>
                    {assignment.dueDate
            ...
            <tbody>
              {classData.studentProgresses.map((progress, index) => (
                <tr key={progress.id || index}>
                  <td>{index + 1}</td>
                  <td>{progress.studentName || progress.student?.fullName || "-"}</td>
                  <td>
        ...
        <div className={styles.ModalHeader}>
          <div className={styles.HeaderInfo}>
            ...
            {classData.description && (
              <p className={styles.HeaderDescription}>{classData.description}</p>
            )}
          </div>
