...
export default function AddSubjectModal({ subject, onClose, onSave }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.subjectCode || formData.subjectCode.trim() === "") {
      newErrors.subjectCode = t.subjectCodeRequired || "Subject code is required";
    }

    if (!formData.subjectName || formData.subjectName.trim() === "") {
      newErrors.subjectName = t.subjectNameRequired || "Subject name is required";
    }
        ...
        <form onSubmit={handleSubmit} className={styles.Form}>
          <div className={styles.FormGroup}>
            ...
            <input
              ...
              placeholder={t.enterSubjectCode || "Enter subject code (e.g., MATH101)"}
