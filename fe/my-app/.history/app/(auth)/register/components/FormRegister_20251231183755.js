  ...
  const renderStep1 = () => (
    <>
      ...
      <FormItem
        ...
        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
        title={t.passwordRequirements || "Password must contain at least one number, one uppercase and lowercase letter, and at least 8 or more characters"}
        required
        ...
        <>
          <div className={styles.StepHeader}>
            ...
            <p className={styles.StepDescription}>
              {t.parentInfoDescription || "Please provide parent/guardian contact information."}
            </p>
          </div>
    ...
    return (
      <>
        <div className={styles.StepHeader}>
          ...
          <p className={styles.StepDescription}>
            {t.teacherInfoDescription || "Please provide your area of expertise."}
          </p>
        </div>
        ...
        <FormItem
          ...
          id="expertise"
          name="expertise"
          placeholder={t.enterExpertise || "Enter area of expertise (e.g., Mathematics, Physics)"}
      ...
      {role && (
        <div className={styles.StepIndicator}>
          ...
          >
            ...
            <span className={styles.StepLabel}>{t.basicInfo || "Basic Info"}</span>
          </div>
          ...
          >
            ...
            <span className={styles.StepLabel}>
              {role === "STUDENT" ? (t.parentInfo || "Parent Info") : (t.teacherInfo || "Teacher Info")}
            </span>
          </div>
        </div>
      )}
      ...
      <form className={styles.FormBody} onSubmit={(e) => e.preventDefault()}>
        ...
        {currentStep === 1 && (
          <div className={styles.FormFooter}>
            <p>
              {t.alreadyHaveAccount || "Already have an account?"} <Link href="/login">{t.loginHere || "Login here"}</Link>
            </p>
          </div>
        )}
      </form>
