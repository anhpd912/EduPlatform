...
export default function FormRegister() {
  ...
  const handleSubmit = (e) => {
    ...
    // Add parent data for Student
    if (role === "STUDENT") {
      if (parentData.parentName) {
        submitData.parentName = parentData.parentName;
      }
      if (parentData.parentPhone) {
        submitData.parentPhone = parentData.parentPhone;
      }
    }

    // Add teacher data for Teacher
    if (role === "TEACHER") {
      if (teacherData.expertise) {
        submitData.expertise = teacherData.expertise;
      }
    }
    ...
    return (
      <>
        ...
        <FormItem
          ...
          id="expertise"
          name="expertise"
          placeholder="Enter area of expertise (e.g., Mathematics, Physics)"
