...
export default function StudentEditModal({ student, isOpen, onClose, onSuccess }) {
  ...
  useEffect(() => {
    if (student) {
      setFormData({
        ...
        gender: student.gender !== null && student.gender !== undefined ? String(student.gender) : "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || t.studentUpdateError || "Failed to update student");
    } finally {
      setLoading(false);
    }
  };
              ...
              <div className={styles.AvatarUpload}>
                ...
                <div className={styles.AvatarActions}>
                  ...
                  >
                    ...
                    {avatarPreview ? (t.changeImage || "Change Image") : (t.uploadImage || "Upload Image")}
                  </button>
                  {avatarPreview && (
                    <button
                      type="button"
