  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (avatarFile) {
        ...
        // Avatar was removed - set flag to delete and send empty file
        userData.deleteAvatar = true;
        submitData.append("image", new Blob(), "empty.png");
      } else {
        // Keep existing - send empty file placeholder (backend will ignore if no deleteAvatar flag)
        submitData.append("image", new Blob(), "empty.png");
        userData.deleteAvatar = false;
      }
