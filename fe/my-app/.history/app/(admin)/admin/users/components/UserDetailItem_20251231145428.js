        ...
        <div className={styles.ModalBody}>
          ...
          <div className={styles.ProfileSection}>
            ...
            <div className={styles.ProfileInfo}>
              <h3 className={styles.FullName}>{user.fullName || user.username}</h3>
          ...
          <div className={styles.DetailsGrid}>
            ...
            <div className={styles.DetailSection}>
              ...
              <div className={styles.DetailItem}>
                ...
                <div className={styles.DetailContent}>
                  <span className={styles.DetailLabel}>{t.email || "Email"}</span>
              ...
              <div className={styles.DetailItem}>
                ...
                <div className={styles.DetailContent}>
                  <span className={styles.DetailLabel}>{t.gender || "Gender"}</span>
                  <span className={styles.DetailValue}>
              ...
              <div className={styles.DetailItem}>
                ...
                <div className={styles.DetailContent}>
                  <span className={styles.DetailLabel}>{t.address || "Address"}</span>
                  <span className={styles.DetailValue}>
            ...
            <div className={styles.DetailSection}>
              ...
              {user.roles && user.roles.length > 0 && (
                <div className={styles.RolesContainer}>
                  <span className={styles.DetailLabel}>{t.roles || "Roles"}</span>
                      ...
                      <div className={styles.PermissionsList}>
                        {user.roles.flatMap((role) =>
                          (role.permissions || []).map((perm, idx) => (
                            <span key={`${role.name}-${idx}`} className={styles.PermissionBadge}>
                              {typeof perm === "string" ? perm : perm.name || "N/A"}
                            </span>
                          ))
                        )}
                      </div>
