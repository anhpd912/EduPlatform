...
export default function UserEditItem({ user, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await UserService.updateProfile(user.id, submitData);
      ...
      toast.error(error.response?.data?.message || t.failedToUpdateUser || "Failed to update user");
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className={styles.ModalBody}>
          ...
          <div className={styles.ModalFooter}>
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? (t.updating || "Updating...") : (t.updateUser || "Update User")}
            </button>
          </div>
        </form>
      </div>
