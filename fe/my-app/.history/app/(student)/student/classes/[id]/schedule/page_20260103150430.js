        ...
        <div className={styles.WeekView}>
          <div className={styles.WeekGrid}>
            {daysOfWeek.map((day, index) => {
              ...
              return (
                <div key={day.id} className={`${styles.DayColumn} ${todayClass}`}>
                    ...
                    {daySchedules.length === 0 ? (
                      ...
                      daySchedules.map((schedule, idx) => {
                        ...
                        return (
                          ...
                          >
                            <div className={styles.ScheduleTime} style={{ color: color.text }}>
                              <MdAccessTime />
                              {formatTime(schedule.startTime)} - {formatTime(schedule.endTime)}
                            </div>
                            <h4 className={styles.SubjectName} style={{ color: color.text }}>
                              {schedule.subject?.name || schedule.subjectName || "Môn học"}
                            </h4>
                            {(schedule.teacher?.fullName || schedule.teacherName) && (
