  ...
  return (
    <div className={styles.chatContainer}>
      ...
      >
        ...
        {/* Tabs - Hide classes tab for ADMIN */}
        {role !== "ADMIN" && (
          ...
          <input
            ...
            placeholder={
              activeTab === "chats"
                ...
                : t.searchClasses || "Search classes..."
            }
            value={searchQuery}
        ...
        <div className={styles.usersList}>
          {activeTab === "chats" || role === "ADMIN" ? (
            <>
              ...
              {/* For Admin - Show users grouped by role */}
              {role === "ADMIN" ? (
                <>
                  {/* Teachers */}
                        ...
                        .map((user) => (
                          ...
                          >
                            ...
                            <div className={styles.userInfo}>
                              ...
                              <span className={styles.userRoleTeacher}>
                                {t.teacher || "Teacher"}
                              </span>
                            </div>
                          </div>
                  ...
                  {/* Other Users (Other Admins) */}
                  {filteredUsers.filter((u) => u.role !== "TEACHER" && u.role !== "STUDENT").length > 0 && (
                    <>
                      <div className={styles.sectionTitle}>
                        {t.admins || "Admins"}
                      </div>
                        ...
                        .map((user) => (
                          ...
                          >
                            ...
                            <div className={styles.userInfo}>
                              ...
                              <span className={styles.userRoleAdmin}>
                                {t.admin || "Admin"}
                              </span>
                            </div>
                          </div>
                            ...
                            <>
                              ...
                              <div
                                className={`${styles.memberItem} ${
                                  selectedChat?.id === cls.teacher.id
                                    ? styles.active
                                    : ""
                                }`}
                                onClick={() =>
                                ...
                                .map((student) => (
                                  ...
                                  >
                                    ...
                                    <div className={styles.memberInfo}>
                                      ...
                                      <span
                                        className={styles.memberRoleTagStudent}
                                      >
                                        {t.student || "Student"}
                                      </span>
                                    </div>
