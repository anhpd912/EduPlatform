...
export default function NavBar() {
  ...
  const handleAcceptInvitation = async (notification) => {
    try {
      ...
      alert(err.response?.data?.message || t.errorAcceptingInvitation || "Error accepting invitation");
    }
  };
  ...
  const handleDeclineInvitation = async (notification) => {
    try {
      ...
      alert(err.response?.data?.message || t.errorDecliningInvitation || "Error declining invitation");
    }
  };
