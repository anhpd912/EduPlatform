...
export const ClassTeacherService = {
  ...
  // Get all joined teachers for a class (teachers with JOINED status)
  getJoinedTeachersByClassId: (classId) => {
    return privateApi.get(`/class-teachers/getJoinedTeachers/${classId}`);
  },
};
